...
<img src="./.readme/badge/version.svg" alt="version 2.2.0">
...
<img src="./.readme/screen/01-overview.png" width="880" alt="The matrix condenses host and service health into a color-coded overview; selecting a cell opens the exact problem context in the companion tile.">
...
<table>
<tr>
<td width="50%" align="center" valign="top"><img src="./.readme/screen/02-matrix.png" alt="The matrix in hosts mode"><br><small><b>Hosts mode</b> - one row per host, every cell the highest open severity behind that check</small></td>
